...
import com.google.javascript.jscomp.lint.*;
...
import static com.google.javascript.jscomp.parsing.parser.FeatureSet.*;
...
public final class DefaultPassConfig extends PassConfig {
  ...
  protected List<PassFactory> getOptimizations() {
     ...
     */
    PassFactory taintAnalysis =
        PassFactory.builder()
            .setName("taintAnalysis")
            .setInternalFactory(TaintPass::new)
            .setFeatureSet(ES2019_MODULES)
            .build();

    passes.add(taintAnalysis);
    ///////////////////  NEW CODE ENDS  ////////////////////////////
